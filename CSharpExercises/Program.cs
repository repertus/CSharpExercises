...
namespace CSharpExercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Assert("MortgageCalculator(300000, 3.8M, 30, 1) should return 1397.87", Exercises.MortgageCalculator(300000, 3.8M, 30, 1) == 1397.87M);
            //Assert("DuckGoose(100) should print correctly", Exercises.DuckGoose(100) == Constants.DuckGooseResult);
            //Assert("Should run correctly", Exercises.Tribonacci(new double[] { 1, 1, 1 }, 0) == new double[] { 1, 1, 1, 3, 5, 9, 17, 31, 57, 105 });
            //Assert("Should run correctly", Exercises.GetSum(1, -2) == -2);
